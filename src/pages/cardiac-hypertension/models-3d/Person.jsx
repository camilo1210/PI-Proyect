...
export function Person({ trigger = false, ...props }) {

  const { nodes, materials } = useGLTF("/models-3d/cardiac-hypertension/person.glb");
  ...
  useEffect(() => {
    ...
    loader.load("/sounds/cough-person.mp3", (buffer) => {
