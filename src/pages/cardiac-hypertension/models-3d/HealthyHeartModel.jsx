...
export function Model(props) {
  ...
  const { nodes, materials } = useGLTF(
    "/models-3d/cardiac-hypertension/healthyHeart.glb"
  );
  ...
  useFrame(({ clock }) => {
    ...
    if (materials.HealthyHeartMaterial) {
      materials.HealthyHeartMaterial.emissive = new THREE.Color(0xff2e63); // rojo brillante
      materials.HealthyHeartMaterial.emissiveIntensity = intensity;
    }
  });
  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        castShadow
        receiveShadow
        geometry={nodes.HealthyHeartModel.geometry}
        material={materials.HealthyHeartMaterial}
        onClick={handleClick}
      />
    </group>
  );
